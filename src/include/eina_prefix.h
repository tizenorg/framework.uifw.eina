...
/**
 * @internal
 * @defgroup Eina_Prefix_Group Prefix Group
...
/**
 * @typedef Eina_Prefix
 * @brief This is a prefix object that is returned by eina_prefix_new() when trying
 ...
 * @since_tizen 2.3
 *
 * @remarks Applications and libraries are most often not just single executables nor
 ...
 *
 * @remarks Being re-locatable at runtime allows much easier distribution and
 ...
 *          @c NULL as @a argv0.
 *
 *          It would prefer to use the @a symbol function to determine the location as
 ...
 *
 * @remarks The @a envprefix parameter, provides a string prefix to prepend before
 ...
 *
 * @remarks The @a sharedir string provides a subdirectory inside the system shared
 ...
 *
 * @remarks The @a magicsharefile is a filename or path of something inside the share
 ...
 *
 * @remarks The @a pkg_bin, @a pkg_lib, @a pkg_data, and @a pkg_locale are compile-time
 ...
 *
 * @remarks Compile the following defining at compile time your prefixes like (example):
 *
 ...
 *
 */
EAPI void eina_prefix_free(Eina_Prefix *pfx);
 ...
 *
 * @param[in] pfx The prefix object
 * @return The base prefix (eg "/usr/local", "/usr", or
 *         "/home/user/myapps/appname" etc.) that the software resides in at runtime
 *
 */
EAPI const char *eina_prefix_get(Eina_Prefix *pfx);
 ...
 *         "/usr/bin", "/home/user/myapps/appname/bin" etc.)
 *
 */
EAPI const char *eina_prefix_bin_get(Eina_Prefix *pfx);
 ...
 *         "/usr/lib32", "/home/user/myapps/appname/lib" etc.)
 *
 */
EAPI const char *eina_prefix_lib_get(Eina_Prefix *pfx);
 ...
 *         "/usr/share/appname", "/home/user/myapps/appname/share/appname" etc.)
 *
 */
EAPI const char *eina_prefix_data_get(Eina_Prefix *pfx);
 ...
 *         "/usr/share/locale", "/home/user/myapps/appname/share/locale" etc.)
 *
 */
EAPI const char *eina_prefix_locale_get(Eina_Prefix *pfx);
